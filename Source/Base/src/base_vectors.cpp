...
Temple::Base::vec2::vec2() : x(0.0f), y(0.0f) {

}

Temple::Base::vec2::vec2(float a, float b) : x(a), y(b) {

}

Temple::Base::vec2::vec2(const vec2& a) : x(a.x), y(a.y) {

}

Temple::Base::vec2::vec2(vec2&& a) : x(a.x), y(a.y) {

}

Temple::Base::vec2& Temple::Base::vec2::operator=(const vec2& a) {
    this->x = a.x;
    this->y = a.y;
    return *this;
}

Temple::Base::vec2& Temple::Base::vec2::operator=(vec2&& a) noexcept {
    this->x = a.x;
    this->y = a.y;
    return *this;
}

std::ostream& Temple::Base::operator <<(std::ostream& os, const Temple::Base::vec2& v) {
...
Temple::Base::vec3::vec3(vec3&& a) : x(a.x), y(a.y), z(a.z) {
...
Temple::Base::vec4::vec4(const vec4& a) : x(a.x), y(a.y), z(a.z), w(a.w) {

}

Temple::Base::vec4::vec4(vec4&& a) : x(a.x), y(a.y), z(a.z), w(a.w) {

}

Temple::Base::vec4& Temple::Base::vec4::operator=(const vec4& a) {
    x = a.x;
    y = a.y;
    z = a.z;
    w = a.w;
...
Temple::Base::vec4& Temple::Base::vec4::operator=(vec4&& a) noexcept {
    x = a.x;
    y = a.y;
    z = a.z;
    w = a.w;
