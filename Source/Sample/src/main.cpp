...
draw(HWND hWnd)
{
  ...
  SetDIBitsToDevice(hdc, 0, 0, width, height, 0, 0, 0, height, (unsigned char*)frame_data.data(), &bmi, DIB_RGB_COLORS);
  HRESULT hr = DwmFlush();
  if (FAILED(hr))
  {
...
InitInstance(HINSTANCE hInstance, int nCmdShow)
{
  ...
  hWnd = CreateWindowW(
    szWindowClass, szTitle, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, 0, 852, 480, nullptr, nullptr, hInstance, nullptr);
